...
from posixpath import join as pjoin  # WAJIB posixpath, bukan os.path: key .npz
                                       # selalu pakai '/', tapi os.path.join
                                       # pakai '\' di Windows -> KeyError
...
import resvit_transformer_configs as configs
