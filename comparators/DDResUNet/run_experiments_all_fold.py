...
TRAIN_SCRIPT  = os.path.join(PROJECT_ROOT, "train_ddresunet_sota_pytorch.py")
EVAL_SCRIPT   = os.path.join(PROJECT_ROOT, "evaluate_experiment_paper.py")
...
EXPERIMENTS = [
    {"experiment_id": "EXP-DDRESUNET", "experiment_name": "OsmanTamam2023", "fold": i,
     "model": "DDResUNet", "modalities": ["T1", "T2", "FLAIR"]}
    for i in range(1, 5)
]
