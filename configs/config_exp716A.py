CONFIG = {
    ...
    # Experiment
    # =========================
    "experiment_id": "EXP-716A",
    "experiment_name": "CROSS_ATTENTION_DECOMPOSITION", # MSCA = Multi-Scale Cross-Attention
    ...
    "gan": {
    "use_gan": True,
    "lambda_gan": 1.0,  #0.01 (tune 1), 0.5 (tune 2), 1.0 (tune 3, 4, 5)
    "gan_loss": "hinge",
    "d_updates_per_g": 1,
    "warmup_epochs": 20
    },
